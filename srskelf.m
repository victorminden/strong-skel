% SRSKELF   Strong recursive skeletonization factorization (symmetric positive definite).
%
%    F = SRSKELF(A,X,OCC,RANK_OR_TOL,PXYFUN) produces a factorization F of the
...
%
%    F = SRSKELF(A,X,OCC,RANK_OR_TOL,PXYFUN,OPTS) also passes various options to
